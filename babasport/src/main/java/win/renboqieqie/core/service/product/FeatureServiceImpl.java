...
import win.renboqieqie.core.bean.product.Feature;
import win.renboqieqie.core.dao.product.FeatureDao;
import win.renboqieqie.core.query.product.FeatureQuery;
/**
 * 商品属性事务层
 * @author lixu
