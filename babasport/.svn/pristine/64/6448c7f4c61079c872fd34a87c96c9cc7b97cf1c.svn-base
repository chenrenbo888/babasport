package win.renboqieqie.core.service.user;
...
import win.renboqieqie.core.bean.user.Employee;
import win.renboqieqie.core.dao.user.EmployeeDao;
import win.renboqieqie.core.query.user.EmployeeQuery;
/**
 * 员工
 * @author lixu
