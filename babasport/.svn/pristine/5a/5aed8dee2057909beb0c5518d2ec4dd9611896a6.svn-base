package win.renboqieqie.core.service.order;
...
import win.renboqieqie.core.bean.order.Detail;
import win.renboqieqie.core.dao.order.DetailDao;
import win.renboqieqie.core.query.order.DetailQuery;
/**
 * 订单子项(订单详情)
 * @author lixu
